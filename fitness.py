def compute_fitness(
    ...
    """Fitness score, higher is better.
        ...
        w_plddt * pLDDT - w_rmsd * RMSD + w_amyloid * amyloid + w_llps * LLPS
    ...
    Sequence terms (optional, from esm_scores.ESMScorer):
        amyloid: amyloidogenicity probability in [0, 1]
        llps: LLPS propensity probability in [0, 1]
